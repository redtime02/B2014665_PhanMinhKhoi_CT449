<template>
  <div>
    <Header />
    <div class="container">
      <h2 class="text-center mt-4 mb-5">Thêm Hàng Hóa</h2>
  ...
  methods: {
    async submitForm() {
      try {
        ...
        const hangHoa = await HangHoaService.createHangHoa(this.hangHoaData);
        ...
        this.successMessage = "Thêm hàng hóa thành công";
        setTimeout(() => {
    ...
    handleFileChange(event) {
      this.hangHoaData.HinhHangHoa = event.target.files[0];
    },
  },
};
</script>
